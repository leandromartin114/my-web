...
const style =
	'absolute text-base md:text-lg 2xl:text-2xl font-semibold bg-white rounded-md p-1 md:p-2 border-2 y-1/2 x-1/2'
...
export const SocialGrid = () => {
	...
	return (
		<div className='bg-orange-200 border-solid border-orange-600 border-4 2xl:border-8 rounded-full'>
			<ul className='relative w-[240px] h-[240px] sm:w-[300px] sm:h-[300px] md:w-[370px] md:h-[370px] xl:w-[500px] xl:h-[500px] 2xl:w-[620px] 2xl:h-[620px] grid grid-cols-2 items-center justify-items-center p-6 sm:p-8 md:p-10 xl:p-12 2xl:p-16 gap-1'>
				<li>
					<a
