...
export const Contact = ({ imgURL }) => {
	return (
		...
		>
			<div className='text-center max-w-md md:max-w-lg xl:max-w-4xl 2xl:max-w-5xl grid gap-7 items-center justify-items-center'>
				<Large color='text-orange-500'>Contact</Large>
				<div className='max-w-3xl'>
					<Body>
						You want to connect with me? Leave your information and I'll contact
						you soon.
					</Body>
				</div>
				<ContactForm />
			</div>
			<div className='2xl:w-[800px] grid gap-7 items-center justify-items-center'>
