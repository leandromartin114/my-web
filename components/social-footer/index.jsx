...
const style =
	'md:hidden text-base md:text-lg font-semibold text-jelly-bean-800 bg-white rounded-md p-2 border-2 rounded -right-60 -top-2  absolute'
const style2 =
	'md:inline text-base md:text-lg font-semibold text-jelly-bean-800 bg-white rounded-md p-2 border-2 rounded -left-64 absolute'
